...
import "platform_unknown.dart"
    if (dart.library.io) "platform_io.dart"
    if (dart.library.html) "platform_html.dart" as p;

/// A string representing the operating system or platform.
String get operatingSystem => Zone.current[#_operatingSystem] ?? p.os;

/// A string representing the version of the operating system or platform.
///
/// May be empty if no version is known or available.
String get operatingSystemVersion =>
    Zone.current[#_operatingSystemVersion] ?? p.osVersion;
...
///
/// If the [operatingSystem] parameter is supplied, it will override
/// the `operatingSystem` getter's value for code running in the zone.
///
/// If the [operationSystemVersion] parameter is supplied, it will
/// override the `operatingSystemVersion` getter's value for code
/// running in the zone.
R overridePlatform<R>(R body(),
    {String /*?*/ operationSystem, String /*?*/ operatingSystemVersion}) {
  return runZoned(body, zoneValues: {
    if (operatingSystem != null) #_operatingSystem: operatingSystem,
